...
export class QuickAccessComponent implements OnInit {
    ...
    donutChart;
    dataLineChart;
    dataDiscreteBarChart;
    dataPieChart;
    dataScatterChart;
    dataMultiBarChart;
    dataCandlestickBarChart;
    dataOhlcBarChart;
    dataBoxPlotChart;
    dataDonutChart;
    sinAndCos;
    ...
    ngOnInit() {
        ...
        this.dataLineChart = sinAndCos()
        this.dataDiscreteBarChart = [
            {
        ...
        this.dataScatterChart = generateDataScatter(4,40)
        this.dataMultiBarChart = generateDataMultiBar()
        // this.dataCandlestickBarChart = [{values: [
